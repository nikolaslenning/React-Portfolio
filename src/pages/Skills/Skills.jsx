    ...
    return (
        ...
        <div className="skillsCard col-sm-4 card bg-light mb-3 card-border" >
            ...
            <div className="row card-body">
              ...
              <div className="col-sm-4 text-center">
                <img id="html-img"alt="Bootstrap logo" src={bootstrapIMG}></img>
                <p id="img-text" className="text-center">Bootstrap</p>
              </div>              
              <div className="col-sm-4 text-center">
                <img id="html-img"alt="react bootstrap logo" src={reactBootstrapIMG}></img>
                <p id="img-text" className="text-center">React-Bootstrap</p>
              </div>              
              <div className="col-sm-4 text-center">
                <img id="html-img"alt="SASS logo" src={sassIMG}></img>
                <p id="img-text" className="text-center">SASS</p>
              </div>              
            </div>
        </div>
